...
VALUES (NEXT VALUE FOR dbo.Employee_Number_seq, 1234567890123, 'John', 'Doe', 'Smith', '2020-01-01', 1234567890, 'john.doe@example.com', '123 Main St, City, Country');

INSERT INTO dbo.EMPLOYEE (Employee_Number, Id_Number, First_Name, Middle_Name, Last_Name, Hire_Date, Phone_Number, Email_Address, Physical_Address)
VALUES (NEXT VALUE FOR dbo.Employee_Number_seq, 1234567890456, 'Jane', 'Doe', 'Williams', '2020-01-15', 1234567891, 'jane.williams@example.com', '456 Elm St, City, Country');

INSERT INTO dbo.EMPLOYEE (Employee_Number, Id_Number, First_Name, Middle_Name, Last_Name, Hire_Date, Phone_Number, Email_Address, Physical_Address)
VALUES (NEXT VALUE FOR dbo.Employee_Number_seq, 1234567890789, 'Robert', 'Johnson', 'Brown', '2020-02-01', 1234567892, 'robert.brown@example.com', '789 Oak St, City, Country');

INSERT INTO dbo.EMPLOYEE (Employee_Number, Id_Number, First_Name, Middle_Name, Last_Name, Hire_Date, Phone_Number, Email_Address, Physical_Address)
VALUES (NEXT VALUE FOR dbo.Employee_Number_seq, 1234567890912, 'Emily', 'Smith', 'Taylor', '2020-02-15', 1234567893, 'emily.taylor@example.com', '101 Pine St, City, Country');

INSERT INTO dbo.EMPLOYEE (Employee_Number, Id_Number, First_Name, Middle_Name, Last_Name, Hire_Date, Phone_Number, Email_Address, Physical_Address)
VALUES (NEXT VALUE FOR dbo.Employee_Number_seq, 1234567890321, 'Michael', 'Wilson', 'Davis', '2020-03-01', 1234567894, 'michael.davis@example.com', '111 Cedar St, City, Country');
GO
...
VALUES (NEXT VALUE FOR dbo.Sale_Id_seq, 1000, '2024-05-12', 200.00);

INSERT INTO dbo.SALE (Sale_Id, Employee_Number, Sale_Date_Time, Cash_Received)
VALUES (NEXT VALUE FOR dbo.Sale_Id_seq, 1001, '2024-05-12', 150.00);

INSERT INTO dbo.SALE (Sale_Id, Employee_Number, Sale_Date_Time, Cash_Received)
VALUES (NEXT VALUE FOR dbo.Sale_Id_seq, 1002, '2024-05-13', 300.00);

INSERT INTO dbo.SALE (Sale_Id, Employee_Number, Sale_Date_Time, Cash_Received)
VALUES (NEXT VALUE FOR dbo.Sale_Id_seq, 1003, '2024-05-14', 180.00);

INSERT INTO dbo.SALE (Sale_Id, Employee_Number, Sale_Date_Time, Cash_Received)
VALUES (NEXT VALUE FOR dbo.Sale_Id_seq, 1004, '2024-05-14', 220.00);
GO
...
VALUES (NEXT VALUE FOR dbo.Client_Id_seq, 'CLT001', 'Alice Johnson', 'Johnson and Sons', 1234567890, 'alice@example.com', '456 Elm St, City, Country', 'Additional information about the client', 1);

INSERT INTO dbo.CLIENT (Client_Id, Client_Code, Contact_Person_Name, Business_Name, Phone_Number, Email_Address, Physical_Address, Additional_Info, Is_Active)
VALUES (NEXT VALUE FOR dbo.Client_Id_seq, 'CLT002', 'Bob Smith', 'Smith Enterprises', 1234567891, 'bob@example.com', '789 Oak St, City, Country', 'Additional information about the client', 1);

INSERT INTO dbo.CLIENT (Client_Id, Client_Code, Contact_Person_Name, Business_Name, Phone_Number, Email_Address, Physical_Address, Additional_Info, Is_Active)
VALUES (NEXT VALUE FOR dbo.Client_Id_seq, 'CLT003', 'Carol Williams', 'Williams Corporation', 1234567892, 'carol@example.com', '101 Pine St, City, Country', 'Additional information about the client', 1);

INSERT INTO dbo.CLIENT (Client_Id, Client_Code, Contact_Person_Name, Business_Name, Phone_Number, Email_Address, Physical_Address, Additional_Info, Is_Active)
VALUES (NEXT VALUE FOR dbo.Client_Id_seq, 'CLT004', 'David Brown', 'Brown Industries', 1234567893, 'david@example.com', '111 Cedar St, City, Country', 'Additional information about the client', 1);

INSERT INTO dbo.CLIENT (Client_Id, Client_Code, Contact_Person_Name, Business_Name, Phone_Number, Email_Address, Physical_Address, Additional_Info, Is_Active)
VALUES (NEXT VALUE FOR dbo.Client_Id_seq, 'CLT005', 'Emma Taylor', 'Taylor Co.', 1234567894, 'emma@example.com', '222 Maple St, City, Country', 'Additional information about the client', 1);
GO
...
VALUES (NEXT VALUE FOR dbo.Equipment_Id_seq, 'EQP006', 'Soldering Iron', 'Tool used for soldering electrical connections', 15, 0, 1);

INSERT INTO dbo.EQUIPMENT (Equipment_Id, Equipment_Code, Name, Description, Quantity, Quantity_Checked_Out, Is_Active)
VALUES (NEXT VALUE FOR dbo.Equipment_Id_seq, 'EQP007', 'Wire Stripper', 'Tool used for stripping insulation from electrical wires', 20, 0, 1);
GO
...
VALUES (NEXT VALUE FOR dbo.Job_Id_seq, 1000, 1, GETDATE(), GETDATE(), 'Fix geyser heating element');

INSERT INTO dbo.JOB (Job_Id, Employee_Number, Client_Id, Start_Date_Time, End_Date_Time, Job_Description)
VALUES (NEXT VALUE FOR dbo.Job_Id_seq, 1001, 2, GETDATE(), GETDATE(), 'Repair fridge compressor');

INSERT INTO dbo.JOB (Job_Id, Employee_Number, Client_Id, Start_Date_Time, End_Date_Time, Job_Description)
VALUES (NEXT VALUE FOR dbo.Job_Id_seq, 1004, 3, GETDATE(), NULL, 'Fix lighting fixture');
GO
